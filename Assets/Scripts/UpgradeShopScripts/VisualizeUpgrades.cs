...
public class VisualizeUpgrades : MonoBehaviour
{
    ...
    [SerializeField] private GameObject NavigationControlUpgrade1;
    [SerializeField] private GameObject NavigationControlUpgrade2;
    [SerializeField] private GameObject NavigationControlUpgrade3;
    ...
    public void visualizeUpdates(){
        ...
        visualizeSingleUpdate("navigationControls");
    ...
    public void visualizeSingleUpdate(string upgradeName){
        ...
        switch(upgradeName){
            ...
            case "navigationControls":
                square1 = NavigationControlUpgrade1;
                square2 = NavigationControlUpgrade2;
                square3 = NavigationControlUpgrade3;
                upgradeBoolArray = upgradeManager.getUpgradeArray(upgradeName);
                break;
    ...
    public void upgradeNavigationControls(){
        bool success = upgradeManager.buyUpgrade("navigationControls");
        if(success){
            visualizeUpdates();
        }
    }
